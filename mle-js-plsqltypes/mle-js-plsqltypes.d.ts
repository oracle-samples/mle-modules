 ...
 * JavaScript API for Oracle type INTERVAL DAY TO SECOND.
 */
declare class IOracleIntervalDayToSecond {
    /**
 ...
 * JavaScript API for Oracle type INTERVAL YEAR TO MONTH.
 */
declare class IOracleIntervalYearToMonth {
    /**
 ...
 */
declare interface CompareOptionalArguments {
    /**
...
declare class IOracleClob {
     ...
     */
    static createTemporary(cache: boolean, duration?: number): any;
    /**
     * This method compares two entire LOBs or parts of two LOBs.
     *
     * @param lob1 First target for comparison.
 ...
 */
declare class IOracleTimestampTZ {
    /**
 ...
 * JavaScript API for Oracle type TIMESTAMP.
 */
declare class IOracleTimestamp {
    /**
