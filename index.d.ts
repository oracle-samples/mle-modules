 ...
 */
interface IBindObjectValue extends IBindDef {
    /**
 ...
 */
type BindValue = IBindObjectValue | object | number | string | boolean | null | undefined;
 ...
 * @since Oracle 23.7
 */
type FetchTypeHandler = (metaData?: IMetaData) => null | {
    type: number;
    converter: Converter;
} | {
    type: number;
 ...
 */
export class TextEncoder implements TextEncoderCommon {
    /**
 ...
 */
export class TextDecoder implements TextDecoderCommon {
    #private;
    /**
...
interface IConsole {
     ...
     */
    assert(check: boolean, message: string): undefined;
